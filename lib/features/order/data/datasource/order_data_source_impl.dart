  ...
  Future<List<BubbleTeaEntity>> getData() async {
    ...
    final result = [
      ...
      const BubbleTea(
        ...
        description: 'Alley',
        image:
            'https://assets.grab.com/wp-content/uploads/sites/11/2020/02/17001253/12-11-e1581869717293.jpg',
        price: 27000,
        bestSeller: true,
      ),
      const BubbleTea(
        ...
        description: 'Trà sữa trân châu',
        image:
            'https://josdiary.files.wordpress.com/2019/07/the-alley-sua-tuoi-tran-chau-duong-den-1.jpg',
        price: 31350,
        bestSeller: false,
      ),
      const BubbleTea(
      ...
      const BubbleTea(
        ...
        description: 'Đen',
        image:
            'https://feelingteaonline.com/wp-content/uploads/2020/08/s%C6%B0a-tuoi-tc-%C4%91%C6%B0%E1%BB%9Dng-%C4%91en.jpg',
        price: 34200,
        bestSeller: true,
      ),
      const BubbleTea(
        ...
        description: 'Sữa đen',
        image:
            'https://product.hstatic.net/200000140863/product/62.sua_tuoi_tran_chau_duong_den_fc61ec21aef74e6093d6916542cc9d76_1024x1024.png',
        price: 40000,
        bestSeller: false,
      ),
      const BubbleTea(
